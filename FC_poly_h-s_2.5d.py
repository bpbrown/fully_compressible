...
averages.add_task(x_avg(grad(Υ0+Υ1))@ez, name='grad_lnρ(z)')
averages.add_task(-1/(grad(Υ0)@ez), name='H_ρ0(z)')
averages.add_task(x_avg(-1/(grad(Υ0+Υ1)@ez)), name='H_ρ(z)')
averages.add_task(Υ0-Υ0(z=Lz), name='n_ρ0(z)')
averages.add_task(x_avg(Υ0+Υ1)-x_avg(Υ0+Υ1)(z=Lz), name='n_ρ(z)')
