"""
Dedalus script for 2D anelastic convection in a polytrope,
...
if no_slip:
    ...
    problem.add_equation((ez@(ex@Eij(z=Lz)), 0))
    problem.add_equation((ez@(ey@Eij(z=Lz)), 0))
problem.add_equation((integ(𝜛1),0))
...
averages.add_task(f_ρ, name='f_ρ(z)')
...
averages.add_task(ρ, name='ρ(z)')
averages.add_task(grad(Υ0)@ez, name='grad_lnρ0(z)')
averages.add_task(grad(Υ0)@ez, name='grad_lnρ(z)')
averages.add_task(-1/(grad(Υ0)@ez), name='H_ρ0(z)')
averages.add_task(-1/(grad(Υ0)@ez), name='H_ρ(z)')
averages.add_task(Υ0-Υ0(z=Lz), name='n_ρ0(z)')
averages.add_task(Υ0-Υ0(z=Lz), name='n_ρ(z)')
